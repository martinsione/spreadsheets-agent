...
export function Stat({
  ...
  return (
    <div
      className={clsx(
        "border-olive-950/20 border-l pl-6 dark:border-white/20",
        className,
      )}
      {...props}
    >
      <div className="text-2xl/10 text-olive-950 tracking-tight dark:text-white">
        {stat}
      </div>
      <p className="mt-2 text-olive-700 text-sm/7 dark:text-olive-400">
        {text}
      </p>
    </div>
  );
